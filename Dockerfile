...
#RUN npm install -g typescript@"TYPESCRIPT_VERSION" toca corregir como instalar typescript
...
RUN apt-get update && apt-get -y install openjdk-8-jdk openjfx
